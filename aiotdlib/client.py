...
class Client:
    ...
    def __init__(
        ...
        self.__auth_action_overriders =  {}

        if isinstance(auth_action_overriders, dict):
            self.__auth_action_overriders.update(auth_action_overriders)
        ...
        while not self.__is_authorized:
            ...
            while True:
                try:
                    ...
                    next_action = auth_actions.get(
                        self.__current_authorization_state)
